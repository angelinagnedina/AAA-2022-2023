...
def get_level_order_keys_and_levels(preorder_keys: list) -> list:
    """
    Выдаёт список вершин по уровням, начиная с корня, а так же список уровней
    для каждой из них.

    :param preorder_keys: список вершин,
    :return: изменённый список вершин, а также список уровней.
    """
